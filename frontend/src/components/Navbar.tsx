            ...
            <div className="flex flex-col gap-3 pt-4">
              ...
              {!user && (
                <button
                  ...
                  className="mx-4 px-6 py-2 bg-gradient-to-r from-orange-400 to-orange-600 text-white font-semibold rounded-full hover:shadow-lg transition-all duration-300"
                >
                  Get Start
                </button>
              )}
